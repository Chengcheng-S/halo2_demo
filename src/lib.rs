...
#[derive(Default)]
struct FIBONACircuit<F>(PhantomData<F>);

impl<F: Field> Circuit<F> for FIBONACircuit<F> {
...
pub mod show_main {
    use super::FIBONACircuit;
    use halo2_proofs::{dev::MockProver, pasta::Fp};
    use std::marker::PhantomData;

    #[cfg(feature = "dev-graph")]
    pub fn plot_fibonacci1() {
    ...
    pub fn fibonacci_example1() {
        println!("will run fibonacci example ......");
        ...
        let circuit = FIBONACircuit(PhantomData);
        ...
        println!("verify success that's all right");
    }
}
